...
{{-- first panel start --}}
    ...
    <ul class="mx-4">
    <li class="p-2"><i class="fa-solid fa-check-double bg-black text-white p-1 rounded-md"></i> <span class="font-semibold">All Entries</span></li>
    <li class="p-2"><i class="fa-solid fa-check-double bg-black text-white p-1 rounded-md"></i> <span class="font-semibold">Travel</span></li>
    <li class="p-2"><i class="fa-solid fa-check-double bg-black text-white p-1 rounded-md"></i> <span class="font-semibold">Education</span></li>
    <li class="p-2"><i class="fa-solid fa-check-double bg-black text-white p-1 rounded-md"></i> <span class="font-semibold">Mental Health</span></li>
    <li class="p-2"><i class="fa-solid fa-check-double bg-black text-white p-1 rounded-md"></i> <span class="font-semibold">Health and Fitness</span></li>
    <li class="p-2"><i class="fa-solid fa-check-double bg-black text-white p-1 rounded-md"></i> <span class="font-semibold">Career</span></li>
    <li class="p-2"><i class="fa-solid fa-check-double bg-black text-white p-1 rounded-md"></i> <span class="font-semibold">Random Thoughts</span></li>
    </ul>
    </div>
{{-- first panel end --}}
