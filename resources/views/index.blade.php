...
{{-- first panel start --}}
    ...
    <li class="p-2 hover:text-green-700 hover:underline"><i class="fa-solid fa-check-double bg-white text- p-1 rounded-md"></i> <span class="font-semibold tooltip" data-tip="{{$category['category_name']}}">{{Str::limit($category['category_name'],17)}}</span></li>
    @endforeach
